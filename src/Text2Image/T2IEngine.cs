...
namespace SwarmUI.Text2Image
{
    ...
    public static class T2IEngine
    {
        ...
        public static HashSet<string> DisregardedFeatureFlags = ["sd3", "flux-dev", "text2video", "cascade", "sdxl", "text2audio", "optional_reference_latent", "model_has_ipadapter", "supports_reference_only"];
